...
interface LocadorProtectedRouteProps {
...
const LocadorProtectedRoute = ({ children }: LocadorProtectedRouteProps) => {
...
export default LocadorProtectedRoute;
